            ...
            <div class="mt-3 catalog-topbar">
                    ...
                    <div class="d-md-none w-100 filters-mobile">
                        ...
                        <select id="categoria-select-mobile" class="form-select categoria-select-mobile">
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option 
                                    value="<?php echo e($cat->id_categoria); ?>"
                                    <?php echo e(in_array((string)$cat->id_categoria, array_map('strval', $selectedCats), true) ? 'selected' : ''); ?>

                                >
                                    <?php echo e($cat->cat_descripcion); ?>
                ...
                <div class="catalog-right-top mt-2 mt-md-0">
                    ...
                    <div class="catalog-pager">
                        <?php echo e($productos->appends(request()->query())->onEachSide(2)->links()); ?>
