...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/coldmarket.css')); ?>">
...
<body>
    ...
    <?php if(session('success')): ?>
        <div class="alert alert-success container mt-4"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
...
</html><?php /**PATH F:\Documents\Martin Herrera\UNIVERSIDAD\CARRERA INGENIERIA EN SISTEMAS DE LA INFORMACIÓN\QUINTO SEMESTRE\Desarrollo_Basado_Plat_HERD\proyecto_integrador_ecommerce\resources\views/layouts/portada.blade.php ENDPATH**/ ?>