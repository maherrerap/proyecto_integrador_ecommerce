<?php $__env->startSection('contenido'); ?>
    <section class="hero-section">
        ...
        <div class="hero-watermark">
            <img src="<?php echo e(asset('images/cold_tech_logo.png')); ?>" alt="Cold Market Watermark" class="img-fluid">
        </div>

        <div class="hero-logo-container">
            <img src="<?php echo e(asset('images/cold_tech_logo.png')); ?>" alt="Cold Market Logo" class="hero-logo">
        </div>
                ...
                <div class="col-12 col-sm-10 col-md-9 col-lg-8 mx-auto text-center">
                    <div class="glass-card">
                        ...
                        <div class="hero-cta-container">
                            <a href="<?php echo e(route('producto.index')); ?>" class="btn btn-lg btn-hero">
        ...
        <div class="container-fluid section-container">
            <div class="row align-items-center g-4 g-lg-5">
                <div class="col-12 col-lg-6 d-flex justify-content-center">
                    <img src="<?php echo e(asset('images/why-choose-us.jpg')); ?>" alt="Por qué elegirnos"
    ...
    <section id="categorias" class="categories-section">
        <div class="container-fluid section-container">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('producto.index')); ?>" class="btn btn-lg btn-primary-custom">
                    Ver Catálogo Completo
                </a>
            </div>
        </div>
    ...
    <section class="featured-products-section">
        <div class="container-fluid section-container">
                        ...
                        <div class="featured-product-card">
                            <div class="featured-product-image">
                                ...
                                <?php if(file_exists(public_path($imagenPath))): ?>
                                    <img src="<?php echo e(asset($imagenPath)); ?>" alt="<?php echo e($producto->pro_descripcion); ?>" class="featured-img"
                                        loading="lazy">
                                <?php else: ?>
                            ...
                            <div class="card-body text-center featured-product-body">
                                ...
                                <p class="featured-product-category">
                                    <?php echo e($producto->categoria->cat_descripcion ?? 'Producto'); ?>

                                </p>
                                <p class="featured-product-price">
                                    $<?php echo e(number_format($producto->pro_precio_venta, 2)); ?>
            ...
            <div class="text-center">
                <a href="<?php echo e(route('producto.index')); ?>" class="btn btn-outline-primary btn-lg btn-explore-more">
                    Ver Catálogo Completo
                </a>
            </div>
        </div>
        ...
        <div class="container-fluid section-container">
            ...
            <div class="team-grid">
                <div class="col-sm-6 col-lg-3">
                    <div class="team-card">
                        <div class="team-photo">
                            <img src="<?php echo e(asset('images/jose.jpeg')); ?>" alt="Jose Zumarraga" class="team-img">
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-card">
                        <div class="team-photo">
                            <img src="<?php echo e(asset('images/maria.jpeg')); ?>" alt="Maria Astudillo" class="team-img">
                        </div>
                        <div class="card-body text-center team-card-body">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-card">
                        <div class="team-photo">
                            <img src="<?php echo e(asset('images/martin.jpeg')); ?>" alt="Martin Herrera" class="team-img">
                        </div>
                        <div class="card-body text-center team-card-body">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-card">
                        <div class="team-photo">
                            <img src="<?php echo e(asset('images/matheo.jpeg')); ?>" alt="Matheo Iza" class="team-img">
                        </div>
                        <div class="card-body text-center team-card-body">
...
<?php echo $__env->make('layouts.portada', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Documents\Martin Herrera\UNIVERSIDAD\CARRERA INGENIERIA EN SISTEMAS DE LA INFORMACIÓN\QUINTO SEMESTRE\Desarrollo_Basado_Plat_HERD\proyecto_integrador_ecommerce\resources\views/portada/index.blade.php ENDPATH**/ ?>