    ...
    <div class="login-split-container">
        <div class="login-split-wrapper">
            ...
            <div class="login-split-image">
                <img src="<?php echo e(asset('images/split_ColdMarket.png')); ?>" alt="ColdMarket Shopping">
            </div>
...
unset($__errorArgs, $__bag); ?>" id="email"
                                    name="email" placeholder="Ingresa tu usuario o correo" value="<?php echo e(old('email')); ?>" required
                                    autocomplete="email">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\proyecto_integrador_ecommerce\resources\views/auth/login.blade.php ENDPATH**/ ?>