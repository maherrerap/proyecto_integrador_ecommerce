        ...
        <nav class="navbar navbar-dark navbar-expand-lg">
            <div class="container-fluid px-4">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#coldmarketNavbar" aria-controls="coldmarketNavbar" aria-expanded="false"
                    aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>

                <div class="collapse navbar-collapse" id="coldmarketNavbar">
                    <ul class="navbar-nav ms-lg-4 me-auto mb-2 mb-lg-0 gap-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link nav-link-coldmarket fw-semibold dropdown-toggle" href="#" role="button"
